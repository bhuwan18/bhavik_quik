      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-md w-full">
        ...
        <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-6 space-y-3">
          {[
            ...
            { icon: "🏆", text: "Collect them all for a certificate" },
          ].map(({ icon, text }) => (
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-semibold text-lg py-4 px-6 rounded-xl hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
        >
