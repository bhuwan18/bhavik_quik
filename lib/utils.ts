...
import {
  ...
  Calculator, FlaskConical, Atom, Globe, Flag, Tag, PawPrint, Swords, GraduationCap, Map, Plane, Gamepad2,
} from "lucide-react";
...
export const CATEGORIES = [
  ...
  { slug: "gaming",         label: "Gaming",          icon: Gamepad2,          color: "text-indigo-400", premiumTier: 2 as const },
] as const;
