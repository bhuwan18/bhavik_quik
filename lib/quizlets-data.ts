...
export const QUIZLETS_DATA: QuizletDef[] = [
  ...
  { name: "Event Horizon", rarity: "secret", pack: "space-pack", icon: "⚫", colorFrom: "#0a0a0a", colorTo: "#1a0533", description: "The boundary beyond which nothing — not even knowledge — can escape.",                                          isHidden: true, sellValue: 1000 },
  { name: "Nebulox",       rarity: "secret", pack: "space-pack", icon: "🌠", colorFrom: "#0d1b2a", colorTo: "#1b2a4a", description: "Born from the collision of two dying stars, made entirely of cosmic dust and ambition.",                       isHidden: true, sellValue: 1000 },
  { name: "Sol Prime",     rarity: "secret", pack: "space-pack", icon: "☀️", colorFrom: "#1c0a00", colorTo: "#7c2d12", description: "The first sun. Has seen every civilisation rise and burn out. Still burning.",                                isHidden: true, sellValue: 1000 },
  { name: "Astrova",       rarity: "secret", pack: "space-pack", icon: "🛸", colorFrom: "#0f172a", colorTo: "#1e3a5f", description: "An ancient probe launched before humanity had words for the stars. Still transmitting.",                      isHidden: true, sellValue: 1000 },
